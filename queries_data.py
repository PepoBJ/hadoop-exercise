...
country_delay_flight_df = spark.sql('SELECT country_code, country_name, avg(delay_time) as delay_time FROM t_flight_history GROUP BY country_code, country_name ORDER BY delay_time DESC')
